...
public class Grid : MonoBehaviour {
	...
	void Awake () {
        ...
        combinedLayermask = WallLayerMask | LocusMask;
        CreateGrid();
	}
	...
	void CreateGrid()
    {
        ...
        for (int x = 0; x < gridSizeX; x++)
        {
            for (int y = 0; y < gridSizeY; y++)
            {
                ...
                bool walkable = !(Physics.CheckSphere(worldPoint, nodeRadius,combinedLayermask));
                bool buildable = !(Physics.CheckSphere(worldPoint, nodeRadius, LocusMask));
                ...
                grid[x, y] = new Node(walkable, worldPoint, x, y,buildable);
            }
        }
    }
